...
<input type="hidden" id="gamename" value="2025 Hobsons Bay Juniors Rapid Championship">
<iframe id="myframe" align=center src="http:///vega.html?pgnFile=/2025 Hobsons Bay Juniors Rapid Championship0.pgn"  width=430 height=680 frameborder=0></iframe>		  </div>
		      </div>
